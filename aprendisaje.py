...
class QLearningAgent:
    ...
    def decay_epsilon(self):
        """Reduce epsilon de forma multiplicativa."""
        self.epsilon = max(self.epsilon_min, self.epsilon * self.epsilon_decay)


# ================================================================
# 2. Configuración del Entorno y del Entrenamiento
# ================================================================
...
for episode in range(EPISODES):
    ...
    if (episode + 1) % 1000 == 0:
        print(f"Episodio {episode+1}/{EPISODES} | "
              ...
              f"Recompensa reciente: {total_reward}")

print("\nEntrenamiento completado.")


# ================================================================
# 3. Visualización del Progreso (Media Móvil)
# ================================================================
def plot_moving_average(data, window_size=100):
    moving_avg = np.convolve(data, np.ones(window_size)/window_size, mode="valid")
    
    plt.figure(figsize=(12, 6))
    plt.plot(moving_avg, label=f"Media móvil ({window_size} episodios)")
...
# ================================================================
# 4. Demostración del Agente Entrenado
# ================================================================
print("\n🎥 Ejecutando demostración visual del agente...\n")
